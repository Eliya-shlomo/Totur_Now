...
| 0.6 | [Client core: axios, interceptor, ErrorBoundary, UI primitives](PR-0.6-client-core.md) | DEV-A | M | 0.5 | ☑ in review |
| 0.7 | [Seed script: topics tree + 15 demo teachers](PR-0.7-seed.md) | DEV-A | M | 0.2 | ☑ in review |
